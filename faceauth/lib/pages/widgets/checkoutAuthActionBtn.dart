...
class CheckOutAuthActionButton extends StatefulWidget {
  CheckOutAuthActionButton(this._initializeControllerFuture,
  ...
  @override
  _CheckOutAuthActionButtonState createState() => _CheckOutAuthActionButtonState();
}

class _CheckOutAuthActionButtonState extends State<CheckOutAuthActionButton> {
  /// service injection
  ...
  Future _signUp(context) async {
    ...
    // // print(response.body);
    print("FinalData:${json.encode(response.body)}");
    //  Clipboard.setData(ClipboardData(text: json.encode(response.body)));
  ...
  Future _signIn(context) async {
    ...
    if (this.predictedUser.user == user) {
      Navigator.push(
          context,
          MaterialPageRoute(
